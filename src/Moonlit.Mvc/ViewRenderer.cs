...
namespace Moonlit.Mvc
{
    ...
    public class ViewRenderer
    {
        ...
        public string RenderView(string viewPath, object model, string layout)
        {
            return RenderViewToStringInternal(viewPath, model, layout, false);
        }
        ...
        /// <returns>String of the rendered view or null on error</returns>
        public static string RenderView(string viewPath, object model, string layout,
                                        ControllerContext controllerContext)
        {
            ViewRenderer renderer = new ViewRenderer(controllerContext);
            return renderer.RenderView(viewPath, model, layout);
        }
        ...
        protected string RenderViewToStringInternal(string viewPath, object model, string layout,
                                                    bool partial = false)
        {
            ...
            if (partial)
                ...
                viewEngineResult = ViewEngines.Engines.FindView(Context, viewPath, layout);

            if (viewEngineResult == null)
                throw new FileNotFoundException("View Not founded");
